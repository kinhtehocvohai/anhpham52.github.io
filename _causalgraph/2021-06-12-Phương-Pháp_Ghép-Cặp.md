...
Một cách để giải quyết vấn đề là đóng lại "cửa sau" bằng cách ghép cặp theo X. Ý tưởng là chúng ta muốn nhìn vào quan hệ giữa Can thiệp và Y giữa các thành phố có giá trị X tương tự nhâu. Một cách khác là nhìn vào quan hệ giữa Can thiệp và Y sau khi loại bỏ tác động của X. Bằng cách đo, chúng ta đóng lại con đường Can thiệp ← X → Y, và chỉ giữ lại Can thiệp → Y mà ta quan tâm. Sau khi kiểm soát X, mối quan hệ còn lại giữa Can thiệp và Y là quan hệ nhân quả (giả sử lối đi "cửa sau" duy nhất là qua X).
